...
import scripts.GlobalFunction.getCTItemByODName;
global odItemMap as IItemStack[string] = {
  ...
  plateStone : getCTItemByODName(<ore:plateStone>),
  ...
  boltWood : getCTItemByODName(<ore:boltWood>),
  boltStone : getCTItemByODName(<ore:boltStone>),
  boltIron : getCTItemByODName(<ore:boltIron>),
  boltGold : getCTItemByODName(<ore:boltGold>),
  boltCopper : getCTItemByODName(<ore:boltCopper>),
  boltTin : getCTItemByODName(<ore:boltTin>),
  boltSilver : getCTItemByODName(<ore:boltSilver>),
  boltLead : getCTItemByODName(<ore:boltLead>),
  boltAluminum : getCTItemByODName(<ore:boltAluminum>),
  boltNickel : getCTItemByODName(<ore:boltNickel>),
  boltPlatinum : getCTItemByODName(<ore:boltPlatinum>),
  boltIridium : getCTItemByODName(<ore:boltIridium>),
  boltSteel : getCTItemByODName(<ore:boltSteel>),
  boltElectrum : getCTItemByODName(<ore:boltElectrum>),
  boltInvar : getCTItemByODName(<ore:boltInvar>),
  boltBronze : getCTItemByODName(<ore:boltBronze>),
  boltConstantan : getCTItemByODName(<ore:boltConstantan>),
  boltSignalum : getCTItemByODName(<ore:boltSignalum>),
  boltLumium : getCTItemByODName(<ore:boltLumium>),
  boltEnderium : getCTItemByODName(<ore:boltEnderium>),
